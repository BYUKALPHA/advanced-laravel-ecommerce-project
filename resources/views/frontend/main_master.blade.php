                        ...
                        <div class="top_bar_content ml-auto">
                            <div class="top_bar_menu">
                                <ul class="standard_dropdown top_bar_dropdown">
                                    ...
                                    <li>
                                        <a href="#">UGX Uganda<i class="fas fa-chevron-down"></i></a>
                                        <ul>
                                            <li><a href="#">$ US Dollar Euro</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{ URL('/') }}"> <img src="{{ asset('frontend/images/logo_alpha.png')}}" alt="">   </a></div>
                        </div>
                    </div>
@php
            ...
            <div class="custom_dropdown">
                <div class="custom_dropdown_list">
                    ...
                    <ul class="custom_list clc">
                        ...
                        <li><a class="clc" href="#">{{ $cat->category_name_en }}</a></li>
                          @endforeach
                    </ul>
                </div>
            </div>
