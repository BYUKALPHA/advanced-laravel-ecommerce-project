           ...
           @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name">@if(session()->get('language') == 'french') {{ $product->product_name_fr }} @else {{ $product->product_name_en }} @endif</h1>
							...
							<div class="description-container m-t-20">
								@if(session()->get('language') == 'french') {{ $product->short_descp_fr }} @else {{ $product->short_descp_en }} @endif
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if(session()->get('language') == 'french') 
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('frontend/assets/images/banners/LHS-banner.jpg') }}" alt=""></a>
			</div><!-- /.image -->			
