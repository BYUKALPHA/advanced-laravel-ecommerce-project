...
@php
$featured = DB::table('items')->where('status',1)->orderBy('id','desc')->limit(8)->get();
$trend = DB::table('items')->where('status',1)->where('trend',1)->orderBy('id','desc')->limit(8)->get();
$best = DB::table('items')->where('status',1)->where('best_rated',1)->orderBy('id','desc')->limit(8)->get();

$hot = DB::table('items')
     ->join('brands','items.brand_id','brands.id')
     ->select('items.*','brands.brand_name_en')
     ->where('items.status',1)->where('hot_deal',1)->orderBy('id','desc')->limit(3)
     ->get();
@endphp
        ...
        @foreach($featured as $row)
            ...
            <div class="featured_slider_item">
                ...
                <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($row->image_one)}}" alt="" style="height:120pc;width:140px;"></div>
                        ...
                        <div class="owl-carousel owl-theme popular_categories_slider">
                            ...
                            <div class="owl-item">
                                <div class="popular_category d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <div class="popular_category_text">{{ $cat->category_name_en }}</div>
                                </div>
                            </div>
                             @endforeach          
...
$mid = DB::table('items')
     ...
     ->join('brands','items.brand_id','brands.id')
     ->select('items.*','brands.brand_name_en','categories.category_name_en')
     ->where('items.mid_slider',1)->orderBy('id','desc')->limit(3)
     ->get();
@endphp
    <!-- Banner -->
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        <div class="banner_2_category"><h4>{{ $row->category_name_en }}</h4></div>
                                        <div class="banner_2_title">{{ $row->product_name }}</div>
                                        <div class="banner_2_text"><h4>{{ $row->brand_name_en }}</h4><br>
                ...
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title">Category one Products</div>
                            <ul class="clearfix">
                                <li class="active"></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title">Category Two Products</div>
                            <ul class="clearfix">
                                <li class="active"></li>
                ...
                <div class="col">
                    <div class="brands_slider_container">
                        ...
                        <div class="owl-carousel owl-theme brands_slider">
                            ...
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center"><img src="{{ asset($row->brand_image)}}" alt="" style="height:80px;width:120px;"></div>
                            </div>
                            @endforeach
