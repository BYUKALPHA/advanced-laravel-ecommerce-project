...
<head>
  <meta charset="utf-8">
    ...
    <title>Quick Pick Admin - Log in </title>
...
<body class="hold-transition theme-primary bg-gradient-primary">
	...
	<input type="email" id="email" class="form-control pl-15 bg-transparent text-white plc-white" name="email" placeholder="Username" :value="old('email')">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
