...
<div class="row">
	...
	<div class="col-md-6">
	    <div class="form-group">
			...
			<div class="controls">
			 <input type="text" name="post_title_en" class="form-control" placeholder="Add Post Title English">
		     @error('post_title_en') 
			 <span class="text-danger">{{ $message }}</span>
			 @enderror
	 		 </div>
...
<div class="row"> <!-- start 6th row  -->
	<div class="col-md-6">
	    <div class="form-group">
			...
			<div class="controls">
			 <input type="text" name="post_title_fr" class="form-control" placeholder="Add Post Title French">
		     @error('post_title_fr') 
			 <span class="text-danger">{{ $message }}</span>
			 @enderror
	 		 </div>
